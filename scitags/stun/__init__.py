...
# https://github.com/jfsanchez91/pystun3/blob/py3-support/LICENSE
# https://github.com/jtriley/pystun/blob/develop/LICENSE
#
...
def get_ip_info(source_ip="0.0.0.0", source_port=54320, stun_host=None,
                stun_port=3478, ip6=False, source_ip6="::"):
    if ip6:
