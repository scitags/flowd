...
It provides a pluggable system to test different flow and packet marking strategies using  *plugins* to generate flow 
...
- **ebpf_el8 and epbf_el9** - implementation of the IPv6 packet tagging (encodes science domain and activity in the IPv6 flow label, see technical spec for details)
...
## Documentation
**flowd** has the following synopsis:
```
# sbin/flowd --help
